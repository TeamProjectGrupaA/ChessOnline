...
$(document).ready(function () {
    (function () {
        ...
        function F(f) {
            ...
            for (var b in f)if (!0 === f.hasOwnProperty(b)) {
                var n;
        ...
        function K(f) {
            ...
            for (var b = {}, n = 8, m = 0; 8 > m; m++) {
                for (var l = f[m].split(""), r = 0, w = 0; w < l.length; w++)if (-1 !== l[w].search(/[1-8]/))var I = parseInt(l[w], 10), r = r + I; else {
                    var I = b, F = B[r] + n, A;
                    A = l[w];
        ...
        window.ChessBoard = window.ChessBoard || function (f, b) {
                ...
                function I() {
                    for (var a = 0; a < B.length; a++)for (var b = 1; 8 >= b; b++) {
                        var c = B[a] + b;
                        s[c] = c + "-" + n()
                    }
                    b = "KQRBNP".split("");
                ...
                function A(a) {
                    ...
                    for (var C = "white", f = 0; 8 > f; f++) {
                        for (var e = e + ('<div class="' + h.row + '">'), k = 0; 8 > k; k++) {
                            var g = c[k] + d, e = e + ('<div class="' + h.square + " " + h[C] + " square-" + g + '" style="width: ' + p + "px; height: " + p + 'px" id="' + s[g] + '" data-square="' + g + '">');
                            if (!0 === b.showNotation) {
                ...
                function ha(a, e, c, d) {
                    ...
                    g.animate(e,
                        {
                            duration: b.moveSpeed, complete: function () {
                            f.append(D(c));
                            g.remove();
                            "function" === typeof d && d()
                        }
                ...
                function ka(a, b) {
                    a = a.split("");
                    var c = B.indexOf(a[0]) + 1, d = parseInt(a[1], 10);
                    b = b.split("");
                    var g = B.indexOf(b[0]) + 1, f = parseInt(b[1], 10), c = Math.abs(c - g), d = Math.abs(d - f);
                    return c >= d ? c : d
                }
                ...
                function U(a, b) {
                    for (var c in J)if (!0 === J.hasOwnProperty(c)) {
                        var d = J[c];
                ...
                function na(a) {
                    ...
                    e = $("#" + s[a]).offset();
                    y.animate(e, {
                        duration: b.snapSpeed, complete: function () {
                            G();
                            y.css("display", "none");
                ...
                b = b || {};
                var fa = K("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR"), h = {
                    alpha: "alpha-d2270",
                    black: "black-3c85d",
                    board: "board-b72b1",
                    ...
                    square: "square-55d63",
                    white: "white-1e1d7"
                }, v, x, y, S, T, q = {}, ea = 2, u = "white", g = {}, p, E, H, t, z = !1, M = {}, s = {}, J;
                q.clear = function (a) {
                    q.position({}, a)
                };
                q.destroy = function () {
                ...
                q.move = function () {
                    if (0 !== arguments.length) {
                        for (var a = !0, b = {}, c = 0; c < arguments.length; c++)if (!1 === arguments[c])a = !1; else {
                            var d;
                            d = arguments[c];
                ...
                q.position = function (a, b) {
                    ...
                    !0 === Q(a) && (a = K(a));
                    if (!0 !==
                        F(a))r(6482, "Invalid value passed to the position method.", a); else if (!0 === b) {
                        var c = g, d = a, c = m(c), d = m(d), f = [], h = {}, k;
                        for (k in d)!0 === d.hasOwnProperty(k) && (!0 === c.hasOwnProperty(k) && c[k] === d[k]) && (delete c[k], delete d[k]);
                        for (k in d)if (!0 === d.hasOwnProperty(k)) {
                            var l;
                            a:{
                                l = c;
                ...
                if (W = !0 ===
                        function () {
                            ...
                            if (a = typeof window.$)if (a = $.fn)if (a = $.fn.jquery)var a = $.fn.jquery, b = "1.7.0", a = X(a), b = X(b), a = !0 === 1E8 * a.major + 1E4 * a.minor + a.patch >= 1E8 * b.major + 1E4 * b.minor + b.patch;
